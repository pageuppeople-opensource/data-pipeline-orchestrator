...
class ModelChangeDetector(object):
    ...
    def main(self):
        ...
        # a class per execution-mode? IExecutionMode.Execute(...)? DI?
        # - connect to db using args.db_connection_string and add a record to DataPipelineExecution table
        # with str(uuid.uuid4())
    ...
    def get_arguments(self):
        ...
        parser.add_argument('execution_mode',
                            ...
                            help='execution mode; choose from {0}'.format(
        ...
        parser.add_argument('db_connection_string',
                            ...
                            help='database connection string, e.g. '
                                 'postgresql+psycopg2://postgres:xxxx@localhost/dest_dw')
